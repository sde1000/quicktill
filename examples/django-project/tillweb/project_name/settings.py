...
ADMINS = (
    # Please set this to your own email address if you want to be
    # emailed when errors occur!
...
STATICFILES_DIRS = (
    ...
    "{{ project_directory }}/tillweb/static",
)
...
TEMPLATE_DIRS = (
    ...
    # Always use forward slashes, even on Windows.
    # Don't forget to use absolute paths, not relative paths.
    "{{ project_directory }}/tillweb/templates",
)
...
LOGGING = {
    ...
    'handlers': {
        ...
        'logfile': {
            ...
            'filename': '{{project_directory}}/tillweb-errors.log',
        },
    },
    'loggers': {
        'django.request': {
